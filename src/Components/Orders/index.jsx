...
const filterOptions = [
    { name: 'Delivered', inStock: true },
    { name: 'On The Way', inStock: true },
    { name: 'Cancelled', inStock: true },
    { name: 'Returned', inStock: true }
  ]
  
export default function OrdersComponent() {
    const [mem, setMem] = useState(filterOptions[0])

    const deliveryStatus = () => {
        return(
            <div>
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-medium leading-6 text-gray-900">Filters</h2>
            </div>
      
            <RadioGroup value={mem} onChange={setMem} className="mt-2">
              <RadioGroup.Label className="sr-only">Choose a memory option</RadioGroup.Label>
              <div className="grid grid-cols-2 gap-3 md:grid-cols-4 my-4">
  ...
  return (
    <div className="bg-gray-50">
      <div className="py-24">
        ...
        <div className="mx-auto max-w-7xl sm:px-2 lg:px-8 my-6">
          <div className="mx-auto max-w-2xl px-4 lg:max-w-4xl lg:px-0">
            {deliveryStatus()}
          </div>
        </div>
        
        <section aria-labelledby="recent-heading" className="mt-8 md:mt-16 mx-2">
