      ...
      sections: [
        {
          ...
          name: 'Clothing',
          items: [
            { name: 'Tops', href: '/women/clothing/top' },
            { name: 'Dresses', href: '#' },
...
export default function Navbar() {
  ...
  return (
    <div className="bg-white sticky top-0 z-[50]">
      ...
      <header className="relative z-50 border-b border-gray-300">
          ...
          <div>
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center gap-4">
                ...
                <>
                  {isUserLoggedIn ? userInfo() : <button type="button" onClick={handleSignUpAndLogin} className='p-2'>
                    <LogIn size={35} color="#7b7a7f" strokeWidth={1.25} className="h-6 w-6 text-gray-400 group-hover:text-gray-500" />
                  </button>
                  }
                </>
